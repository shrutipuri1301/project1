...
public class DatabaseConnection {
	...
	public static Connection getConnection() throws Exception {
		...
		return DriverManager.getConnection("jdbc:mysql://localhost:3306/onlineexam", "root", "Shruti@Puri");
	}
	...
	public static String randompasswordgeneration() {
		...
		for (int i = 0; i < PASSWORD_LENGTH; i++) {
			...
			password += letters.substring(index, index + 1);//define the ending and starting index of string
		}
		return password;
	}
}